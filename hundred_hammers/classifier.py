...
class HundredHammersClassifier(HundredHammersBase):
    ...
    def __init__(self, models=None, metrics=None, eval_metric=None,
                 cross_validator=StratifiedKFold, cross_validator_params={"shuffle": True, "n_splits": 5},
                 test_size=0.2, n_folds_tune=5, n_evals=10, show_progress_bar=False, seed_strategy='sequential'):
        if models is None:
